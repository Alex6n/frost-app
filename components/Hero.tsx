  ...
  return (
    <div className="hero-section flex h-[72vh] items-center justify-center lg:h-[85vh] relative">
      <div className="mx-auto mt-[400px] z-30 tracking-tight absolute">
        <h1 className="text-[50px] md:text-[80px] font-bold text-center text-transparent bg-clip-text bg-gradient-to-b from-[#ffffff] to-[#bfd7f3]">
          {title}
        </h1>
        <p className="text-[25px] md:text-[30px] text-center font-bold text-transparent bg-clip-text bg-gradient-to-b from-[#ffffff] to-[#bfd7f3]">
          {description}
        </p>
